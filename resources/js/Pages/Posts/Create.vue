                        ...
                        <div class="container my-2">
                            <section v-if="editor" class="buttons flex items-center flex-wrap gap-x-4 bg-white border-gray-400 p-3 border-t border-l border-r tiptap">
                                ...
                                <button 
                                    ...
                                    <CodeIcon :size="24" title="Code" />
                                </button>

                                <button @click="editor.chain().focus().setParagraph().run()" :class="{ '': editor.isActive('paragraph') }">
                                    <ParagraphIcon :size="24" title="Paragraph" />
                                </button>
                                
                                <button @click="editor.chain().focus().toggleHeading({ level: 1 }).run()" :class="{ 'bg-gray-200': editor.isActive('heading', { level: 1 }) }">
                                    <H1Icon :size="24" title="H1" />
                                </button>
                                <button @click="editor.chain().focus().toggleHeading({ level: 2 }).run()" :class="{ 'bg-gray-200': editor.isActive('heading', { level: 2 }) }">
                                    <H2Icon :size="24" title="H2" />
                                </button>
                                <button @click="editor.chain().focus().toggleHeading({ level: 3 }).run()" :class="{ 'bg-gray-200': editor.isActive('heading', { level: 3 }) }">
                                    <H3Icon :size="24" title="H3" />
                                </button>
                                <button @click="editor.chain().focus().toggleBulletList().run()" :class="{ 'bg-gray-200': editor.isActive('bulletList') }">
                                    <BulletListIcon :size="24" title="Bullet List" />
                                </button>
                                <button @click="editor.chain().focus().toggleOrderedList().run()" :class="{ 'bg-gray-200': editor.isActive('orderedList') }">
                                    <OrderedListIcon :size="24" title="Ordered List" />
                                </button>
                                <button @click="editor.chain().focus().toggleCodeBlock().run()" :class="{ 'bg-gray-200': editor.isActive('codeBlock') }">
                                    <CodeBlockIcon :size="24" title="Code Block" />
                                </button>
                                <button @click="editor.chain().focus().toggleBlockquote().run()" :class="{ 'bg-gray-200': editor.isActive('blockquote') }">
